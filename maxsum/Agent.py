...
class Agent:
    ...
    def removeNodeVariable(self,nodevariable):
        '''
           nodevariable: NodeVariable
           Remove nodevariable from the nodevariables of the Agent 
        '''
        self.variables.remove(nodevariable)
        
    def removeNodeFunction(self,nodefunction):
        '''
           nodefunction: NodeFunction
           Remove nodefunction from the nodefunctions of the Agent 
        '''
        self.functions.remove(nodefunction)
    ...
    def sendQMessages(self,iter):
        ...
        for variable in self.getVariables():
            ...
            for function in self.getFunctionsOfVariable(variable):
                ...
                '''
                #pdb.set_trace()
                self.op.updateQ(variable, function, self.postservice,iter)
        ...
        #print('SendQMessages elapse_time:', elapse_time)         
    
      
    def sendRMessages(self,iter):
        '''
        ...
        for function in self.getFunctions():
            ...
            for variable in self.getVariablesOfFunction(function):
                ...
                '''    
                #pdb.set_trace()				
                self.op.updateR(function, variable, self.postservice,iter)
        ...
        #elapse_time = time.time() - start_time
        #print('SendRMessages elapse_time:', elapse_time)       
    ...
    def updateZMessages(self):
        ...
        self.postservice.clearMessagesRtoX()
